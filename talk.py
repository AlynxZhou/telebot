...
## To judge if the content is a text and deal with it.
        if content_type == 'text':
            ...
            self.sender.sendMessage(talk_list[self._count],reply_to_message_id=self._msg_id)
            print('Bot:Got text \'%s\' from @%s and answered with \'%s\'.'%(self._text,self._username,talk_list[self._count]))
            print('--------------------------------------------')
